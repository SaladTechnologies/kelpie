...
- [🐕 Kelpie (beta)](#-kelpie-beta)
  ...
  - [Running Multiple Workers Per Node](#running-multiple-workers-per-node)
...
All environment variables supported by kelpie are listed below, and all are optional.

| Variable                        | Description                                                                                                                                                                                                                                                                                                | Default Value                      |
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| FILE_WATCHER_DEBOUNCE_MS        | The amount of time to debounce file change events before checking for stability.                                                                                                                                                                                                                           | "0"                                |
| FILE_WATCHER_MAX_WAIT_MS        | The maximum amount of time to wait for a file to become stable (i.e. not changing in size) before considering it ready for upload. Also the maximum amount of time to respect the debounce, meaning even in a continuously debounced file-watcher operation, the event will still get released this often. Set to `0` to disable. | "5000"                             |
| FILE_WATCHER_STABILITY_CHECK_MS | The amount of time to wait for a file to be stable (i.e. not changing in size) before considering it ready for upload.                                                                                                                                                                                     | "50"                               |
| KELPIE_API_KEY                  | The API key for authenticating with the Kelpie API                                                                                                                                                                                                                                                         | None                               |
| KELPIE_API_URL                  | The URL for the Kelpie API                                                                                                                                                                                                                                                                                 | `https://kelpie.saladexamples.com` |
| KELPIE_LOG_LEVEL                | The log level for kelpie                                                                                                                                                                                                                                                                                   | "info"                             |
| KELPIE_RECREATE_BETWEEN_JOBS    | Whether to recreate the environment between jobs, by deleting and recreating the container. This is useful for ensuring a clean environment, but may increase job startup time, and lead to idle GPU time during uploads.                                                                                  | "false"                            |
| KELPIE_STATE_FILE               | The path to the kelpie state file. This file is used to store the state of the kelpie worker, including the current job, and any in-progress uploads/downloads.                                                                                                                                            | `./kelpie-state.json`              |
| MAX_JOB_FAILURES                | The maximum number of job failures allowed before an instance should reallocate.                                                                                                                                                                                                                           | "3"                                |
| MAX_RETRIES                     | The maximum number of retries for API operations                                                                                                                                                                                                                                                           | "3"                                |
| MAX_TIME_WITH_NO_WORK_S         | The maximum time to wait for work before exiting. May be exceeded by up to 10 seconds (1 heartbeat interval)                                                                                                                                                                                               | "0" (Never)                        |
| SALAD_API_KEY                   | The API key for authenticating with the Salad API and the Kelpie API.                                                                                                                                                                                                                                      | None                               |
| SALAD_CONTAINER_GROUP_ID        | The ID of the Salad container group                                                                                                                                                                                                                                                                        | *set dynamically by Salad*         |
| SALAD_MACHINE_ID                | The ID of the Salad machine                                                                                                                                                                                                                                                                                | *set dynamically by Salad*         |
| SALAD_ORGANIZATION_NAME         | The name of your Salad organization. This can be determined automatically when running on a Salad Node, or can be set manually for testing purposes.                                                                                                                                                       | *set dynamically by Salad*         |
| SALAD_PROJECT_NAME              | The name of your Salad project. This can be determined automatically when running on a Salad Node, or can be set manually for testing purposes.                                                                                                                                                            | None                               |
